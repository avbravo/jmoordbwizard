 ...
 */
package com.avbravo.wizardjmoordb.generador.css;
...
@Named
@RequestScoped
public class CssLayoutCssGenerador implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(CssLayoutCssGenerador.class.getName());
    ...
    public void generar() {
        try {
            ...
            procesar("cssLayout.css", rutas.getPathMainWebappResourcesCss()+ "cssLayout.css");
