...
@Named
@RequestScoped
public class DialogoeliminarxhtmlGenerador implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(DialogoeliminarxhtmlGenerador.class.getName());
    ...
    public void generar() {
        try {
            ...
            procesar("dialogoeliminar.xhtml", proyectoJEE.getPathMainWebappResourcesComponentes()+ proyectoJEE.getSeparator()+"dialogoeliminar.xhtml");
...
fw.write("        <composite:attribute name=\"etiquetaValor\"/>" + "\r\n");
...
fw.write("                  widgetVar=\"confirmDialog\">" + "\r\n");
...
fw.write("                                 update=\"#{cc.attrs.contenedor}\"" + "\r\n");
fw.write("                                 oncomplete=\"PF('confirmDialog').hide();\"" + "\r\n");
...
fw.write("                                 onclick=\"PF('confirmDialog').hide();\" type=\"button\" />" + "\r\n");
fw.write("            </f:facet>" + "\r\n");
fw.write("        </p:dialog>" + "\r\n");
fw.write("    </composite:implementation>" + "\r\n");
fw.write("" + "\r\n");
