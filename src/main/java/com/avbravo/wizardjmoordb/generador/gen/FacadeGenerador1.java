...
@Named
@RequestScoped
public class FacadeGenerador1 implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(FacadeGenerador1.class.getName());
...
//findBy
                    entidad.getAtributosList().stream().forEach((a) -> {
                        ...
                        try {
                            ...
                            Logger.getLogger(FacadeGenerador1.class.getName()).log(Level.SEVERE, null, ex);
                        }
