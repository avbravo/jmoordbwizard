...
@Named
@RequestScoped
public class LoginxhtmlGenerador implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(LoginxhtmlGenerador.class.getName());
...
//      bw.write("Acabo de crear el fichero de texto.");
                ...
                try (FileWriter fw = new FileWriter(file)) {
                    ...
                    fw.write("" + "\r\n");
                    fw.write("                                    <div class=\"col-xs-4\">" + "\r\n");
                    fw.write("                                        <p:password value=\"#{loginController.password}\" class=\"login-input\" id=\"password\" placeholder=\"#{app['login.password']}\"/>" + "\r\n");
                    fw.write("                                    </div>" + "\r\n");
                    fw.write("" + "\r\n");
                    fw.write("                                </div>" + "\r\n");
                    fw.write("" + "\r\n");
