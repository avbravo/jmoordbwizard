...
//set/get
                    ...
                    fw.write("        found = false;" + "\r\n");
                    fw.write("    } catch (Exception e) {" + "\r\n");
                    fw.write("        JsfUtil.errorMessage(\"showAll()\" + e.getLocalizedMessage());" + "\r\n");
                    fw.write("    }" + "\r\n");
                    fw.write("    return \"\";" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
                    ...
                    fw.write("        found = true;" + "\r\n");
                    fw.write("    } catch (Exception e) {" + "\r\n");
                    fw.write("        JsfUtil.errorMessage(\"query()\" + e.getLocalizedMessage());" + "\r\n");
                    fw.write("    }" + "\r\n");
                    fw.write("    return \"\";" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
                    ...
                    fw.write("        writable = true;" + "\r\n");
                    fw.write("    } catch (Exception e) {" + "\r\n");
                    fw.write("        JsfUtil.errorMessage(\"verifyNew()\" + e.getLocalizedMessage());" + "\r\n");
                    fw.write("    }" + "\r\n");
                    fw.write("    return \"\";" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
                    ...
                    fw.write("            reset();" + "\r\n");
                    fw.write("        } else {" + "\r\n");
                    fw.write("            JsfUtil.successMessage(\"save() \" + " + nameEntity + "Facade.getException().toString());" + "\r\n");
                    fw.write("        }" + "\r\n");
                    fw.write("      " + "\r\n");
                    fw.write("    } catch (Exception e) {" + "\r\n");
                    fw.write("        JsfUtil.errorMessage(\"save()\" + e.getLocalizedMessage());" + "\r\n");
                    fw.write("    }" + "\r\n");
                    fw.write("    return \"\";" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
                    ...
                    fw.write("    } catch (Exception e) {" + "\r\n");
                    fw.write("        JsfUtil.errorMessage(\"edit()\" + e.getLocalizedMessage());" + "\r\n");
                    fw.write("    }" + "\r\n");
                    fw.write("    return \"\";" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
                    ...
                    fw.write("            }" + "\r\n");
                    fw.write("        } catch (Exception e) {" + "\r\n");
                    fw.write("            JsfUtil.errorMessage(\"delete() \" + e.getLocalizedMessage());" + "\r\n");
                    fw.write("        }" + "\r\n");
                    fw.write("        return \"\";" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
                    ...
                    fw.write("            }" + "\r\n");
                    fw.write("        } catch (Exception e) {" + "\r\n");
                    fw.write("            JsfUtil.errorMessage(\"remove()\" + e.getLocalizedMessage());" + "\r\n");
                    fw.write("        }" + "\r\n");
                    fw.write("        return \"\";" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
...
//                    fw.write("            String ruta = \"/resources/reportes/" + nameEntity + "/" + nameEntity + ".jasper\";" + "\r\n");
                    ...
                    fw.write("            JsfUtil.errorMessage(\"imprimir() \" + ex.getLocalizedMessage());" + "\r\n");
                    fw.write("        }" + "\r\n");
                    fw.write("    return null;" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
                    ...
                    fw.write("            " + nameEntity + "DataModel = new " + nameClass + "DataModel(" + nameEntity + "List);" + "\r\n");
                    fw.write("        } catch (Exception ex) {" + "\r\n");
                    fw.write("            JsfUtil.errorMessage(\"handleSelect() \" + ex.getLocalizedMessage());" + "\r\n");
                    fw.write("        }" + "\r\n");
                    fw.write("    }// </editor-fold>" + "\r\n");
                    fw.write("" + "\r\n");
                    fw.write("" + "\r\n");
